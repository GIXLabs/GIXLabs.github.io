...
![Image of where the power switch is](/assets/images/cnc_setup/turn_on_machine.png)

Open ShopBot 3.

![ShopBot 3 software icon](/assets/images/cnc_setup/open_shopBot3.png)

If you get a pop-up that says 'STOP Button is ON!', Press the blue re-set button.

![Blue reset button](/assets/images/cnc_setup/reset_button.png)
...
![The move tool UI on the software](/assets/images/cnc_setup/open_moveTool.png)
...
![Up arrow on the moveTool ](/assets/images/cnc_setup/move_z_up.png)
...
![vacuum brush](/assets/images/cnc_setup/remove_brush-min.gif)

To remove the current bit, use the wrenches on the magnet holder on the side of the machine to loosen the tool.

![location of where the wrenches are](/assets/images/cnc_setup/wrench_location.png)

![what the wrench should look like when being used](/assets/images/cnc_setup/wrench_fitting.jpeg)
...
![Image of the nut, collet, and bit](/assets/images/cnc_setup/tool_parts.png)
...
![assembled nut, collet, and but](/assets/images/cnc_setup/tool_setup.png)
...
![homing button on the software](/assets/images/cnc_setup/home_xy.png)

Press OK on the pop-up. Select the yellow 'To Move Tool'.

![move tool button on the software](/assets/images/cnc_setup/open_moveTool.png)
...
![arrow buttons](/assets/images/cnc_setup/move_coordinates.png)

Press the blue 'Zero Axes' button and reset the machine’s X and Y zero-position to the current position.

![zero axes button](/assets/images/cnc_setup/zero_axis.png)

![zero the x and y options](/assets/images/cnc_setup/zero_xy.png)
...
![z calibration plate](/assets/images/cnc_setup/z_plate.png)

Clip the Z-axis calibration clip to the chuck.

![clipped chuck on the z-axis](/assets/images/cnc_setup/plate_under_bit.png)
...
![homing z axis button](/assets/images/cnc_setup/home_z_button.png)
...
![glue gun plugged in next to desk](/assets/images/cnc_setup/glue_gun.png)
...
![marking the edges of the stock on the corner of the table](/assets/images/cnc_setup/trace_stock.png)
...
![painters tape attached to table and stock](/assets/images/cnc_setup/tape_stock.png)
...
![stock secured to the table](/assets/images/cnc_setup/secure_stock.png)
...
![spindle power on](/assets/images/cnc_setup/turn_on_spindle.png)
...
![powermatic remote](/assets/images/cnc_setup/powermatic.png)

Once everything is prepared, press 'Cut Part'.

![cut part button on the software](/assets/images/cnc_setup/cut_part.png)
...
![start button on the software](/assets/images/cnc_setup/start_button.png)

Before pressing 'OK' on the next pop-up menu, press the green start button on the CNC router remote.

![reset button on the CNC router remote](/assets/images/cnc_setup/reset_button.png)
